...
class ToolResult:
    ...
    output: Any
    error: str | None = None
    side_effect: str | None = None  # e.g. "tts_dispatched", "behavior_requested"
...
class ToolRegistry:
    ...
    def dispatch(self, tool_name: str, args: dict[str, Any]) -> ToolResult:
        ...
        logger.debug(
            "Tool %s → success=%s latency=%.1fms", tool_name, result.success, result.latency_ms
        )
        return result
    ...
    def _handle_behavior(self, args: dict[str, Any]) -> ToolResult:
        ...
        from bonbon_llm.safety.authorization import AuthorizationConfig, CommandAuthorizer
