...
_HINT_RESPONSES = {
    ...
    "retreat": SpatialResponse(
        pause_navigation=True,
        gesture="slight_retreat",
        gesture_priority=12,
        say="Sorry, I'll give you some space.",
        tts_emotion="calm",
        escalate_to_operator=False,
        operator_severity=0,
...
_ALERT_RESPONSES = {
    "restricted_zone_entry": SpatialResponse(
        ...
        gesture="",
        gesture_priority=0,
        say="Please be aware that area is restricted.",
        tts_emotion="concerned",
        escalate_to_operator=True,
        operator_severity=3,  # HIGH
